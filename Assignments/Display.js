...
class Display extends Component {
    constructor() {
        super();
        this.state = {editIndex :-1,cStatus:false, cLocal:false,cCentral:false,customercode1:101 ,Customer: { customercode: '', customername: '', status: '', custtype: '' }, CustomerData: [], CData:[]};
    }
    onChangeHandler = (e) => {
        ...
        let { Customer,customercode1 } = this.state;
        this.setState({ Customer: { ...Customer, [name]: value } })
       
    }
    onSubmit = (e) => {
        e.preventDefault();
        let { CustomerData, Customer, editIndex,customercode1 } = this.state;
        if(editIndex>=0)
        {
            CustomerData[editIndex] = Customer;
        } else {
            Customer.customercode=""+customercode1;
            this.setState({Customer:Customer});
            console.log("code1",Customer);
        ...
        this.setState({customercode1:customercode1+1});
        console.log("code",customercode1);
    ...
    render() {
        let { Customer,customercode1, cStatus, CData, cLocal, cCentral } = this.state;
        return (
            <>
                <div className='row'>
                    <div className="col-md-4">
                        <form onSubmit={this.onSubmit}>
                            ...
                            <div className="form-group">
                                ...
                                <input type="number" className="form-control" name="customercode1" value={customercode1}  />
                            </div>
                            <div className="form-group">
